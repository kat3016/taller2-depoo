...
public class SandboxConjuntos
{
    ...
    public List<String> getCadenasComoListaInvertida( )
    {
    	 ...
    	 Collections.sort(listaInvertida, Collections.reverseOrder());
    ...
    {
    	 NavigableSet<String> descendingSet = arbolCadenas.descendingSet();
    	    return new TreeSet<>(descendingSet);
    }
    ...
    public boolean compararElementos( String[] otroArreglo )
    {
        ...
        return arbolCadenas.containsAll(lista);
    }
